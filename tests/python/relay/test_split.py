...
if __name__ == "__main__":
    print('works')
    model_path = '/projects/vbu_projects/users/achiar/CEVA_DEV/InV/dev_ai/NetworkExamples/ONNX/Opensource/SAOperators/conv_relu_add_split/deploy.onnx'
    test_Add_SA(model_path)
    print('worked')
